    		...
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				<div class="row">
    					<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    					<?php
    					$sql="SELECT * FROM `product_clothing` WHERE `clothing_id`='$id'";
    					$result=mysqli_query($conn,$sql);
    					if($result->num_rows > 0){
    						while($row=mysqli_fetch_assoc($result)){
    							// echo $row['clothing_id'];
    					?>
		    			<div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
		    				<div class="product">
		    					<a href="product-single.php?id=<?= $row['id']; ?>" class="img-prod"><img class="img-fluid" src="images/<?= $row['clothing_id']; ?>-<?= $row['img_id']; ?>.jpg" alt="Colorlib Template">
